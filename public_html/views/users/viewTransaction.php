            ...
            foreach ($product as $item) { ?>
                <div class="well">
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                <a class="btn btn-primary text-center" href="viewTransaction?ProductType=<?=$item->__get('ProductType')?>&SerialNumber=<?= $item->__get('SerialNumber')?>&transactionID=<?=$viewmodel->__get('transactionID')?>">Return Product</a>
                            </td>
                        </tr>
                        </tbody>
                    </table>
