                ...
                foreach ($product as $item) { ?>
                    <div class="well">
                        <a class="btn btn-primary text-center"
                           href="viewSpecs?ProductType=<?= $item->__get('ProductType') ?>&SerialNumber=<?= $item->__get('SerialNumber') ?>">View
                            Product Specs</a>
                        <a class="btn btn-primary text-center"
                           href="?ProductType=<?= $item->__get('ProductType') ?>&SerialNumber=<?= $item->__get('SerialNumber') ?>">Remove
                            Product</a>
                        <table class="table">
                            <p><?php echo $item->__get('ProductType'); ?></p>
                            <tbody>
                            <tr>
                                <td>Brand:<?php echo $item->__get('Brand') ?> </td>
                            </tr>
                            <tr>
                                <td>Model Number:<?php echo $item->__get('ModelNumber') ?> </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Weight:<?php echo $item->__get('Weight') ?> </td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
