...
<div class="text-center">
    ...
    <div>
        ...
        <a class="btn btn-primary text-center" href="editProductSpecs?ProductType=<?= $product->__get('ProductType') ?>&SerialNumber=<?= $product->__get('SerialNumber') ?>">View/Edit Product
            Specs</a>
