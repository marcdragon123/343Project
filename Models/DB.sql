...
-- -----------------------------------------------------
-- Table `compstor_db`.`Television_tbl`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `compstor_db`.`Television_tbl` (
  `ID` INT(11) NOT NULL,
  `Key` VARCHAR(10) NULL,
  `Value` VARCHAR(10) NULL,
  `SerialNumber` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`ID`, `SerialNumber`),
  INDEX `SerialNumberTelevision_idx` (`SerialNumber` ASC),
  CONSTRAINT `SerialNumberTelevision`
    FOREIGN KEY (`SerialNumber`)
    REFERENCES `compstor_db`.`Purchaselist_tbl` (`ProductSerialNumber`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `compstor_db`.`Tablet_tbl` (
  ...
  `SerialNumber` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`ID`, `SerialNumber`),
  INDEX `SerailNumberTablet_idx` (`SerialNumber` ASC),
  CONSTRAINT `SerailNumberTablet`
    FOREIGN KEY (`SerialNumber`)
    REFERENCES `compstor_db`.`Purchaselist_tbl` (`ProductSerialNumber`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `compstor_db`.`Laptop_tbl` (
  ...
  `SerialNumber` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`ID`, `SerialNumber`),
  INDEX `SerialNumberLaptop_idx` (`SerialNumber` ASC),
  CONSTRAINT `SerialNumberLaptop`
    FOREIGN KEY (`SerialNumber`)
    REFERENCES `compstor_db`.`Purchaselist_tbl` (`ProductSerialNumber`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `compstor_db`.`Monitor_tbl` (
  ...
  `SerialNumber` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`ID`, `SerialNumber`),
  INDEX `SerialNumberMonitor_idx` (`SerialNumber` ASC),
  CONSTRAINT `SerialNumberMonitor`
    FOREIGN KEY (`SerialNumber`)
    REFERENCES `compstor_db`.`Purchaselist_tbl` (`ProductSerialNumber`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `compstor_db`.`DesktopComputer_tbl` (
  ...
  `SerialNumber` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`ID`, `SerialNumber`),
  INDEX `SerialNumberDesktopComputer_idx` (`SerialNumber` ASC),
  CONSTRAINT `SerialNumberDesktopComputer`
    FOREIGN KEY (`SerialNumber`)
    REFERENCES `compstor_db`.`Purchaselist_tbl` (`ProductSerialNumber`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
